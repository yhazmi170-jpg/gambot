...
const SHOP = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'insurance4', name: 'Insurance Upgrade IV (25% refund)', price: 800000, desc: 'raises your loss refund to 25%', monthly: true, use: 'Overrides lower tiers — losses auto-refund 25%' },
