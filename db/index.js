...
function ensureUser(userId) {
  ...
  if (row.length && row[0].values.length) {
    ...
    return {
      user_id: get('user_id'),
      balance: Number.isFinite(get('balance', 0)) ? get('balance', 0) : 0,
      terms_accepted: get('terms_accepted', 0),
      daily_time: get('daily_time', 0),
      daily_streak: get('daily_streak', 0),
      weekly_time: get('weekly_time', 0),
      work_time: get('work_time', 0),
      ...
      rep_time: get('rep_time', 0) || 0,
      auto_react_emoji: get('auto_react_emoji', '') || '',
      badge_emoji: get('badge_emoji', '🏅') || '🏅',
      lb_emoji: get('lb_emoji', '🌟') || '🌟',
      bank: get('bank', 0) || 0,
      loan: get('loan', 0) || 0,
      loan_time: get('loan_time', 0) || 0,
      level: get('level', 1) || 1,
      xp: get('xp', 0) || 0,
      xp_time: get('xp_time', 0) || 0,
      gems: get('gems', 0) || 0,
      essence: get('essence', 0) || 0,
      hunt_eff: get('hunt_eff', 0) || 0,
      hunt_gain: get('hunt_gain', 0) || 0,
      hunt_radar: get('hunt_radar', 0) || 0,
      hunt_xp: get('hunt_xp', 0) || 0,
      autohunt_level: get('autohunt_level', 0) || 0,
      snails: get('snails', 0) || 0,
      snail_time: get('snail_time', 0) || 0,
      snail_bought: get('snail_bought', 0) || 0,
      snail_buy_day: get('snail_buy_day', 0) || 0,
      eggs: get('eggs', 0) || 0,
      hatched: get('hatched', 0) || 0,
      battles_won: get('battles_won', 0) || 0,
      loss_streak: get('loss_streak', 0) || 0,
      last_loss_time: get('last_loss_time', 0) || 0,
      free_bet: get('free_bet', 0) || 0,
      free_bet_time: get('free_bet_time', 0) || 0,
